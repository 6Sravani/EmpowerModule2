...
// So this.value refers to global "this", not obj.
const obj1 = {
  value: 50,
...
// c)
// const prevents reassignment. It protects the binding,
// meaning the variable name cannot be re-pointed.
...
const finalObj = { ...objA, ...objB }; // age overridden
...
// c)
const nested = {};
console.log(nested.a?.b?.c); // prevents error
